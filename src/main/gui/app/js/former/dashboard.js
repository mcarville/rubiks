...
angular.module('dashboard_module', [])
	...
	.controller('DashboardCtrl', ["$rootScope", "$scope", "$http", "$q", "$location", "$timeout", function($rootScope, $scope, $http, $q, $location, $timeout) {
		...
		$scope.initialize = function() {
			initSearchEngineUtils($scope, $http, $q);
			...
			var httpParams = getQueryParams(document.location.search);
			$scope.switchTabMenu(httpParams.menu);
		}
